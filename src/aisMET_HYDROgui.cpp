...
aisMET_HYDROBase::aisMET_HYDROBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_toggleBtn1->Connect( wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnToggleButton ), NULL, this );
	m_buttonStandby->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnData ), NULL, this );
	...
	m_buttonSignal->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnSignalShow ), NULL, this );
	m_button73->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnMessageList ), NULL, this );
	m_button74->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnSelectMessage ), NULL, this );
...
aisMET_HYDROBase::~aisMET_HYDROBase()
{
	...
	m_toggleBtn1->Disconnect( wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnToggleButton ), NULL, this );
	m_buttonStandby->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnData ), NULL, this );
	...
	m_buttonSignal->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnSignalShow ), NULL, this );
	m_button73->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnMessageList ), NULL, this );
	m_button74->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( aisMET_HYDROBase::OnSelectMessage ), NULL, this );
	this->Disconnect( wxID_ANY, wxEVT_TIMER, wxTimerEventHandler( aisMET_HYDROBase::OnTimer ) );

}

aisMET_HYDROPreferences::aisMET_HYDROPreferences( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
...
aisMET_HYDROPreferences::~aisMET_HYDROPreferences()
{
}
